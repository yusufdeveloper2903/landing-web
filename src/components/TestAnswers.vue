...
type TestAnswer = MultipleChoiceAnswer | WrittenAnswer
...
const isTestComplete = computed(() => 
  multipleChoiceAnswers.value.every(answer => answer.selectedAnswer !== '') &&
      ...
      <div class="p-6 sm:p-8">
        ...
        <div class="mb-12">
          ...
          <div class="space-y-3 sm:space-y-4">
            ...
            >
              <!-- Question number -->
              <div class="text-gray-700 font-medium text-sm sm:text-base min-w-0 flex-shrink-0 w-8 sm:w-12">
                {{ answer.question }}
              </div>
        ...
        <div class="mb-8">
          ...
          <div class="space-y-3 sm:space-y-4">
            <div 
              ...
              class="flex items-center space-x-3 sm:space-x-4"
            >
              <label class="text-sm sm:text-base font-medium text-gray-700 min-w-0 flex-shrink-0 w-12 sm:w-16">
                {{ answer.question }}
              </label>
